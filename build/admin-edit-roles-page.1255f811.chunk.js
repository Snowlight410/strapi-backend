(self.webpackChunkmy_project=self.webpackChunkmy_project||[]).push([[2544],{98374:(U,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(27279),h=o(75307),R=o(61020),v=o(40464);const O=(P={},A={})=>{const{id:E="",...S}=P,{get:V}=(0,h.kY)(),{locale:a}=(0,R.Z)(),F=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:N,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",E,S],async()=>{const{data:Q}=await V(`/admin/roles/${E??""}`,{params:S});return Q},A);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>F.compare(oe.name,ee.name))},[m,F]),error:M,isError:N,isLoading:g,refetch:b}}},24233:(U,L,o)=>{"use strict";o.d(L,{V:()=>R});var e=o(75307),h=o(40464);const R=(v={id:null},O={})=>{const{id:P,...A}=v,{get:E}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:F,refetch:m}=(0,h.useQuery)(["roles",P,"permissions",A],async()=>{const{data:{data:M}}=await E(`/admin/roles/${P}/permissions`,{params:A});return M},O);return{permissions:S,error:V,isError:a,isLoading:F,refetch:m}}},25545:(U,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>me,default:()=>Te});var e=o(27279),h=o(9941),R=o(27875),v=o(10701),O=o(48102),P=o(74758),A=o(93415),E=o(32370),S=o(23298),V=o(74577),a=o(12881),F=o(39708),m=o(75307),M=o(76827),N=o(84260),g=o(71563),b=o(10124),z=o.n(b),Q=o(61020),oe=o(59461),ee=o(51447),C=o(19003),de=o(36364),J=o(30909),te=o(90065),Y=o(24233),ue=o(47853);const Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)}),ce=C.default.div`
...
`,F=({children:m,disabled:M=!1,error:N,expanded:g=!1,hasErrorMessage:b=!0,id:z,onToggle:Q,toggle:oe,size:ee="M",variant:C="primary",shadow:de})=>{const J=(0,O.M)(z),te=h.useMemo(()=>({expanded:g,onToggle:Q,toggle:oe,id:J,size:ee,variant:C,disabled:M}),[M,g,J,Q,ee,oe,C]);return(0,e.jsxs)(v.S.Provider,{value:te,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:M,"aria-disabled":M,expanded:g,hasRadius:!0,variant:C,error:N,shadow:de,children:m}),N&&b&&(0,e.jsx)(E.x,{paddingTop:1,children:(0,e.jsx)(P.Z,{variant:"pi",textColor:"danger600",children:N})})]})}},34642:(U,L,o)=>{"use strict";o.d(L,{v:()=>v});var e=o(74081),h=o(39267),R=o(93415);const v=({children:O,...P})=>{const{expanded:A,id:E}=(0,h.A)();if(!A)return null;const S=`accordion-content-${E}`,V=`accordion-label-${E}`,a=`accordion-desc-${E}`;return(0,e.jsx)(R.x,{role:"region",id:S,"aria-labelledby":V,"aria-describedby":a,...P,children:O})}},39267:(U,L,o)=>{"use strict";o.d(L,{A:()=>R,S:()=>h});var e=o(27279);const h=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),R=()=>(0,e.useContext)(h)},24920:(U,L,o)=>{"use strict";o.d(L,{B:()=>m});var e=o(74081),h=o(10411),R=o(19003),v=o(45322),O=o(39267);const P=({expanded:M,disabled:N,variant:g})=>{let b="neutral100";return M?b="primary100":N?b="neutral150":g==="primary"&&(b="neutral0"),b};var A=o(1782),E=o(50703),S=o(10701),V=o(32370);const a=(0,R.default)(A.A)`
  text-align: left;
